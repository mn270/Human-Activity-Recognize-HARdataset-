...
def load_dataset(prefix='/home/marcin/Pobrane/'):
    ...
    y1 = trainy[np.where(trainy == 1)]
    y2 = trainy[np.where(trainy == 2)]
    y3 = trainy[np.where(trainy == 3)]
    x1 = trainX[np.where(trainy == 1), :, :]
    x2 = trainX[np.where(trainy == 2), :, :]
    x3 = trainX[np.where(trainy == 3), :, :]
    ...
    y1_ = testy[np.where(testy == 1)]
    y2_ = testy[np.where(testy == 2)]
    y3_ = testy[np.where(testy == 3)]
    x1_ = testX[np.where(testy == 1), :, :]
    x2_ = testX[np.where(testy == 2), :, :]
    x3_ = testX[np.where(testy == 3), :, :]
